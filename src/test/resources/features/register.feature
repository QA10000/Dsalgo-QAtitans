Feature: User Registration
 ...
 Scenario: Verify that user is able to navigate to Register page
  ...
  #   Given The user is on the register page of the portal
    ...
    # Then The user sees "password and confirm password values do not match"
   ...
   #  Given The user is on the register page of the portal
   #  When The user enters "Qatitans2" in username text box on register page
   #  When The user enters "1@Chicaggo" in password text box on register page
   #  When The user enters "1@Chicaggo" in confirm password text box on register page
   #  When The user clicks the Register button
   #  Then The user lands on the DSAlgo Home portal with Success Message "New Account Created. You are logged in as <RegisterdName>"