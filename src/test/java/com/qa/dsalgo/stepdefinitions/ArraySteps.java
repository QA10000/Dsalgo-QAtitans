...
public class ArraySteps extends DriverScripts {
	...
	public void user_selects_item_from_drop_down(String dropdwnItem, String drpdownlbl) {
		ArrayPage arraypage = new ArrayPage(driver);
		arraypage.selectArrayfrmDrpdown(dropdwnItem);
	}
	...
	public void the_user_should_be_directed_to_array_page_module_page(String moduleName) {
	    ...
	    System.out.println("DEBUG: Page Title = " + actualTitle);
	...
	public void the_user_is_on_array_data_structure() {
		...
		String actualTitle = arraypage.getTitleArraypage();
		Assert.assertEquals(actualTitle, expectedTitle, "Title mismatch!");

	}

	@When("The user clicks {string} link")
	public void the_user_clicks_link(String arryLink) { // this is for link on array page for array in python
		ArrayPage arraypage = new ArrayPage(driver);
		arraypage.clickArrayPythonLink();
	}

	@Given("The user clicks {string} button in Arrays in Python")
	public void the_user_clicks_button_in_arrays_in_python(String tryMeBtn) {
		ArrayPage arraypage = new ArrayPage(driver);
		arraypage.clickTryMeButton();
	}

	@Given("run invalid code by clicking run button after entering {string} in try editor")
	...
	public void the_user_should_sees_alert_with_error_message_on_array_in_python_page(String expectedMessage) {
		ArrayPage arraypage = new ArrayPage(driver);
